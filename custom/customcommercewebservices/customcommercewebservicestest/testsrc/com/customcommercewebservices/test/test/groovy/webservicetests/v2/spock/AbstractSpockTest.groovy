...
import com.customcommercewebservices.test.test.groovy.webservicetests.SSLIssuesIgnoringHttpClientFactory
...
abstract class AbstractSpockTest extends Specification {
	private static String LOG4J_PROPERTIES_CLASS_PATH = "customcommercewebservicestest/log4j.properties";
	...
	protected static ConfigObject config = TestConfigFactory.createConfig("v2", "/customcommercewebservicestest/groovytests-property-file.groovy");
	...
	protected static final String getBasePathWithIntegrationSite() {
		def enableWsIntegrationTest = Config.getBoolean("customcommercewebservicestest.enableWsIntegrationTest", false);
