...
import com.customcommercewebservices.test.test.groovy.webservicetests.TestNamePrinter
import com.customcommercewebservices.test.test.groovy.webservicetests.TestUtil
import com.customcommercewebservices.test.test.groovy.webservicetests.config.TestConfigFactory
import com.customcommercewebservices.test.test.groovy.webservicetests.docu.BaseWSTestWatcher
...
class BaseWSTest {
	...
	public void ignoreIf(){
		org.junit.Assume.assumeTrue(Config.getBoolean("customcommercewebservicestest.enableV1", false))
	}
	...
	protected BaseWSTest() {
		config = TestConfigFactory.createConfig("v1", "/customcommercewebservicestest/groovytests-property-file.groovy");
