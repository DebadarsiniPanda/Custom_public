 ...
 */
package com.customcommercewebservices.test.test.groovy.webservicetests.config
...
public class ModuleConstants {
	...
	//original name of the web services module, it is not touched by modulegen because we are in customcommercewebservicestest
	...
	public static final String CURRENT_TEST_EXTENSION_NAME = 'customcommercewebservicestest';
