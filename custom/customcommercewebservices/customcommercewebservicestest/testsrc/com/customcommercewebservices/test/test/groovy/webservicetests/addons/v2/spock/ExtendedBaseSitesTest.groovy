...
import com.customcommercewebservices.test.test.groovy.webservicetests.v2.spock.AbstractSpockFlowTest
...
class ExtendedBaseSitesTest extends AbstractSpockFlowTest {
	...
	public void ignoreIf() {
		org.junit.Assume.assumeTrue(Config.getBoolean("customcommercewebservicestest.enableAccTest", false))
	}
	...
	Those two fields have to be initialized for junit_cmssite table by file: /commercewebservices-module/customcommercewebservicestest/resources/customcommercewebservicestest/import/coredata/stores/wsTest/site.impex
	*/
