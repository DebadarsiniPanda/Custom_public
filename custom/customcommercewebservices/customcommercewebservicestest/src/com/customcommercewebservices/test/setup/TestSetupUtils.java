...
import com.customcommercewebservices.core.constants.YcommercewebservicesConstants;
...
public class TestSetupUtils
{
	...
	private static void setupCommerce(final BiConsumer<CustomcommercewebservicesTestSetup, SystemSetupContext> triggerEqualsValidator)
	{
		final CustomcommercewebservicesTestSetup setup = getCommerceWebServicesTestSetup();
	...
	private static CustomcommercewebservicesTestSetup getCommerceWebServicesTestSetup()
	{
		return Registry.getApplicationContext().getBean("yCommerceWebServicesTestSetup", CustomcommercewebservicesTestSetup.class);
	}
	...
	private static SystemSetupContext createSystemSetupContext()
	{
		...
		params.put("customcommercewebservicestest_sample", new String[] { "true" });
		params.put("lucenesearch_rebuild", new String[] { "true" });
		params.put("lucenesearch_update.index.configuration", new String[] { "true" });

		return new SystemSetupContext(params, Type.ALL, Process.ALL, "customcommercewebservicestest");
	}
	...
	{
		if (!Config.getBoolean("customcommercewebservicestest.embedded.server.enabled", true))
		{
