 ...
 */
package com.customcommercewebservices.test.setup;
...
public class CustomcommercewebservicesTestSetup extends AbstractSystemSetup
{
	...
	private static final Logger LOG = Logger.getLogger(CustomcommercewebservicesTestSetup.class);
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		getSetupImpexService().importImpexFile("/customcommercewebservicestest/import/sampledata/user-orders.impex", true, false);
		getSetupImpexService().importImpexFile("/customcommercewebservicestest/import/sampledata/paymentmodes.impex", true, false);
	...
	{
		return Config.getBoolean("customcommercewebservicestest.enableWsIntegrationTest", false);
	}
		...
		if (extensionNames.contains("acceleratorwebservicesaddon") || extensionNames.contains("acceleratorocc"))
		{
			storeNames.forEach(store -> {
				getSetupImpexService().importImpexFile(
						String.format("/customcommercewebservicestest/import/acceleratorwebservicesaddon/%s/solr.impex", store), true, true);
				getSetupImpexService().importImpexFile(
						String.format("/customcommercewebservicestest/import/acceleratorwebservicesaddon/%s/site.impex", store), true, true);
			});
		}

		if (extensionNames.contains("yacceleratorfulfilmentprocess"))
		{
			getSetupImpexService().importImpexFile("/customcommercewebservicestest/import/orderprocess/store.impex", true, true);
		}

		if (extensionNames.contains("yacceleratorordermanagement"))
		{
			getSetupImpexService().importImpexFile(
					"/customcommercewebservicestest/import/ordermanagement/projectdata-dynamic-business-process-order.impex", true);
			getSetupImpexService().importImpexFile(
					"/customcommercewebservicestest/import/ordermanagement/projectdata-dynamic-business-process-consignment.impex", true);
			getSetupImpexService().importImpexFile(
					"/customcommercewebservicestest/import/ordermanagement/projectdata-dynamic-business-process-return.impex", true);
			getSetupImpexService().importImpexFile(
					"/customcommercewebservicestest/import/ordermanagement/projectdata-dynamic-business-process-sendReturnLabelEmail.impex",
					true);
			getSetupImpexService().importImpexFile("/customcommercewebservicestest/import/ordermanagement/store.impex", true, true);
		}
	}
	...
	public void initializePromotionEngineModule()
	{
		getSetupImpexService()
				.importImpexFile("/customcommercewebservicestest/import/promotionengine/promotionsmodule.impex", true, false);
	}
	...
	protected void loadIntegrationData()
	{
		...
		{
			getSetupImpexService().importImpexFile("/customcommercewebservicestest/import/integration/cis-integration-data.impex", true);
		}

		if (extensionNames.contains("omssampledata"))
		{
			getSetupImpexService().importImpexFile("/customcommercewebservicestest/import/integration/oms-integration-data.impex", true);
		}
	}
	...
	{
		getSetupImpexService().importImpexFile(
				"/customcommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-categories.impex", true,
				false);
		getSetupImpexService().importImpexFile(
				"/customcommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products.impex", true,
				false);
		getSetupImpexService().importImpexFile(
				"/customcommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products-prices.impex",
				true, false);
		getSetupImpexService().importImpexFile(
				"/customcommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products-stock-levels.impex",
				true, false);
